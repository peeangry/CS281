...
public class UiScoreG extends JFrame {
	...
	public UiScoreG() {
		...
		if (FileConection.getPoint()) {
			txta.setText(Point.getPoint(1) + "");
			txta1.setText(Point.getPoint(0) + "");
			txtbp.setText(Point.getPoint(3) + "");
			txtbp1.setText(Point.getPoint(2) + "");
			txtb.setText(Point.getPoint(5) + "");
			txtb1.setText(Point.getPoint(4) + "");
			txtcp.setText(Point.getPoint(7) + "");
			txtcp1.setText(Point.getPoint(6) + "");
			txtc.setText(Point.getPoint(9) + "");
			txtc1.setText(Point.getPoint(8) + "");
			txtdp.setText(Point.getPoint(11) + "");
			txtdp1.setText(Point.getPoint(10) + "");
			txtd.setText(Point.getPoint(13) + "");
			txtd1.setText(Point.getPoint(12) + "");
			txtf.setText(Point.getPoint(15) + "");
			txtf1.setText(Point.getPoint(14) + "");
		} else {
			txta.setText(a0 + "");
			txta1.setText(a1 + "");
			txtbp.setText(bp0 + "");
